...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/home/gaomingqi',
...
parser.add_argument('--test_every', type=int, default=1200,
...
parser.add_argument('--skip_threshold', type=float, default='1e1',
...
parser.add_argument('--ext_tt', type=str, default='.png',
                    help='data type')
